...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (apiKey) {
	  var document = arguments.length <= 1 || arguments[1] === undefined ? window.document : arguments[1];

	  if (!apiKey) {
	    throw new Error('apiKey must be specified.');
	  }

	  var loaded = load(apiKey, document);

	  return {
	    reverseGeocode: function reverseGeocode(latitude, longitude) {
	      return loaded.then(function (sdk) {
	        return new _promise2.default(function (resolve, reject) {
	          var query = {
	            location: { lat: latitude, lng: longitude }
	          };
	          var geocoder = new sdk.Geocoder();
	...
	var SDK_URL_BASE = '//maps.googleapis.com/maps/api/js';
	var SCRIPT_ID = 'google-maps';
	var CALLBACK_NAME = 'googleMapsInit';
